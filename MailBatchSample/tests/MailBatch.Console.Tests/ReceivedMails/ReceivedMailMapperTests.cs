...
public sealed class ReceivedMailMapperTests
{
    ...
    public void ToRequest_UsesInternalDateAndPlainTextBodyWhenAvailable()
    {
        ...
        ReceivedMailRequest request = new ReceivedMailMapper().ToRequest(new ReceivedMailContent(new UniqueId(1), message, internalDate));
    ...
    public void ToRequest_ConvertsHtmlBodyToReadableTextWhenPlainTextBodyIsMissing()
    {
        ...
        ReceivedMailRequest request = new ReceivedMailMapper().ToRequest(new ReceivedMailContent(new UniqueId(1), message, DateTimeOffset.UnixEpoch));
    ...
    public void ToRequest_UsesMessageDateWhenInternalDateIsMissing()
    {
        ...
        ReceivedMailRequest request = new ReceivedMailMapper().ToRequest(new ReceivedMailContent(new UniqueId(1), message, null));
